...
module Neural.Graph.Fork.Poset where
...
module ForkPosetDefs (G : Graph o ℓ)
  ...
  open ForkConstruction G G-oriented node-eq? hiding (_++_; ++-idr; ++-assoc)  -- Hide ForkPath operators, X uses Path-in operators
  open ForkSurgery G G-oriented node-eq?
  open OrientationProofs G G-oriented node-eq? using (Γ̄-oriented)
