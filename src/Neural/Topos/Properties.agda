...
import Neural.Topos.Alexandrov as NAlexandrov
...
module _ (Γ : OrientedGraph o ℓ) where
  ...
  -- Import definitions from Alexandrov, which re-exports Poset
  open NAlexandrov using (Subset; is-alexandrov-open; principal-ideal; ↓_; Ω-Alexandrov)
  open NPoset.PosetOfGraph Γ
  ...
  postulate
    -- The DNN topos (sheaf category on Fork-Category with fork-coverage)
    DNN-Precategory : OrientedGraph o ℓ → Precategory (lsuc (o ⊔ ℓ)) (o ⊔ ℓ)
    ...
    -}
    DNN-Topos→Presheaves : Functor (DNN-Precategory Γ) Presheaves-CX
    DNN-Topos≃Presheaves : is-equivalence DNN-Topos→Presheaves

    {-|
    Equivalence 2: Sheaves-X-Alexandrov ≃ Presheaves-CX
    From Proposition 1.2, Corollary
    -}
    Sheaves-Alexandrov→Presheaves : Functor Sheaves-X-Alexandrov Presheaves-CX
    Sheaves-Alexandrov≃Presheaves : is-equivalence Sheaves-Alexandrov→Presheaves

    {-|
    Equivalence 3 (derived): DNN-Topos ≃ Sheaves-X-Alexandrov
    By transitivity of equivalences
    -}
    DNN-Topos→Sheaves-Alexandrov : Functor (DNN-Precategory Γ) Sheaves-X-Alexandrov
    DNN-Topos≃Sheaves-Alexandrov : is-equivalence DNN-Topos→Sheaves-Alexandrov
  ...
  **Uniqueness**: This is the unique geometric morphism from E to Set over Set.
  ...
  postulate
    ...
    {-|
    Uniqueness: global-sections is the unique geometric morphism E → Set over Set.
    Any other geometric morphism E → Set is naturally isomorphic to global-sections.
    -}
  ...
  **Geometric interpretation**:
  ...
  Point = Σ[ p* ∈ Functor (Sets (o ⊔ ℓ)) (DNN-Precategory Γ) ]
            ∃[ p-star ∈ Functor (DNN-Precategory Γ) (Sets (o ⊔ ℓ)) ]
              (p* ⊣ p-star)
  ...
  **Intuition**: We can test equality "pointwise" by evaluating at each vertex.
  ...
  postulate
    ...
    sufficiently-many-points :
      ...
      (f g : F => G) →
      (∀ (x : X-Vertex) → let open _=>_ f renaming (η to fη) ;  open _=>_ g renaming (η to gη)
                           in fη x ≡ gη x) → -- f and g agree at x
      f ≡ g
  ...
  **For the DNN topos**:
  ...
  postulate
    ...
    TODO: Formalize the connection between Ω-DNN and Ω-Alexandrov
    -}
    Ω-DNN≅Alexandrov : Type (lsuc (o ⊔ ℓ))
  ...
  **Geometric interpretation**:
  ...
  postulate
    ...
    -- TODO: Define as product of sufficiently-many-points and sub-extensional
